...
SOURCE = runtime_path("gen3_range_filtered_live_safe", "latest_payload.csv")
PACKAGE_SUMMARY = report_path("gen3_range_filtered_candidate_package_v2", "summary.json")
OUT_DIR = report_path("gen3_range_filtered_shadow_only_v2")
RUNTIME_DIR = runtime_path("gen3_range_filtered_shadow")
