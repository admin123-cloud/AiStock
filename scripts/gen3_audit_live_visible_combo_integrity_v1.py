...
LIVE_PAYLOAD = ROOT / "reports" / "gen3_guarded_live_safe_payload_v1" / "g3_guarded_live_safe_payload.csv"
CLOSED_TRADES = ROOT / "reports" / "gen3_guarded_candidate_package_v1" / "g3_guarded_candidate_closed_trades.csv"
PACKAGE_SUMMARY = ROOT / "reports" / "gen3_guarded_candidate_package_v1" / "summary.json"
OUT_DIR = ROOT / "reports" / "gen3_live_visible_combo_integrity_audit_v1"
