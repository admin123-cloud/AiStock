...
DEFAULT_TIER_SIGNALS = REPO_ROOT / "reports" / "gen2_preference_signal_tier_validation" / "signals_with_preference_tiers.csv"
DEFAULT_OUTPUT_DIR = REPO_ROOT / "reports" / "gen2_preference_tier_portfolio_backtest"
