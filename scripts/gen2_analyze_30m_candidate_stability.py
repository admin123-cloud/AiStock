...
DEFAULT_INPUT = REPO_ROOT / "reports" / "gen2_30m_fractal_restart_expanded_w2" / "fractal_triggers.parquet"
DEFAULT_OUTPUT_DIR = REPO_ROOT / "reports" / "gen2_30m_candidate_stability"
