...
SOURCE = ROOT / "reports" / "gen3_range_box_first_panic_distill_second_accept_v1" / "base_with_second_acceptance_flags.csv"
OUT_DIR = ROOT / "reports" / "gen3_range_first_panic_d1_accept_stability_v1"
