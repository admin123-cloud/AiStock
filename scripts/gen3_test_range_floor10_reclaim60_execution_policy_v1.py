...
SOURCE = ROOT / "reports" / "gen3_range_ice_recent3_threshold_stability_v1" / "floor10_reclaim60__cost30" / "closed_trades.csv"
AUDIT_SOURCE = ROOT / "reports" / "gen3_range_floor10_reclaim60_execution_audit_v1" / "audited_trades.csv"
OUT_DIR = ROOT / "reports" / "gen3_range_floor10_reclaim60_execution_policy_v1"
SLOTS = 5
SLOT_PCT = 0.20
DAILY_OPEN_LIMIT = 1
WINDOWS = {
