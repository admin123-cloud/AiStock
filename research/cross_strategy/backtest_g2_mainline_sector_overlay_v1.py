...
OUT = _report_path() / "g2_mainline_sector_overlay_backtest_v1"
...
MAINLINE_CONFIRMED = _report_path() / "true_sector_index_intraday_diffusion_v1" / "confirmed_intraday_diffusion_sectors.csv"
