...
SOURCE = _report_path() / "gen3_range_second_acceptance_v1" / "deep_and_reclaim_any_second_accept_signals.csv"
OUT_DIR = _report_path() / "gen3_range_second_acceptance_exit_v1"
