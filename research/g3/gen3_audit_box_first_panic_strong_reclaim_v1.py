...
ROOT = _PROJECT_ROOT
IN_DIR = _report_path() / "gen3_range_box_structural_entry_v1" / "box_first_panic_strong_reclaim__cost30"
OUT_DIR = _report_path() / "gen3_box_first_panic_strong_reclaim_audit_v1"
