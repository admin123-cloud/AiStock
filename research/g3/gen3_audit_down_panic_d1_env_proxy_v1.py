...
ROOT = _PROJECT_ROOT
OUT_DIR = _report_path() / "gen3_down_panic_d1_env_proxy_audit_v1"

LIVE_SAFE = _report_path() / "gen3_guarded_live_safe_payload_v1" / "g3_guarded_live_safe_payload.csv"
PANIC_CLOSED = _report_path() / "gen3_panic_v2_research" / "final_candidate_v1" / "m30_close5_full_nextopen_cost30_closed_trades.csv"
MARKET_CONTEXT = _report_path() / "gen3_panic_v2_research" / "market_context.csv"
