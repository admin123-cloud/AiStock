...
ROOT = _PROJECT_ROOT
OUT_DIR = _report_path() / "gen3_market_router_absorb_g2v4_v1"

G2_RUN = _report_path() / "gen2_v2_complete_strategy" / "runs" / "official" / "full"
G2_SIGNALS = G2_RUN / "signals.csv"
G2_TRADES = G2_RUN / "trades.csv"
G2_SUMMARY = _report_path() / "gen2_v2_complete_strategy" / "summary.csv"
OPEN_STATE = _report_path() / "gen2_open_state_research_full" / "g2_open_state_daily.csv"
G3_RANGE_CLOSED = (
    _report_path()
