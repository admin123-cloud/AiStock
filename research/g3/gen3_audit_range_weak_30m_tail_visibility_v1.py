...
OUT_DIR = _report_path() / "gen3_range_weak_30m_tail_visibility_v1"
SOURCES = {
    "range_stress_top1": _report_path() / "gen3_range_weak_shadow_mtm_v1" / "range_stress_top1_cost30_closed_trades.csv",
    "weak_low_top1": _report_path() / "gen3_range_weak_shadow_mtm_v1" / "weak_low_top1_cost30_closed_trades.csv",
}
WINDOWS = {
