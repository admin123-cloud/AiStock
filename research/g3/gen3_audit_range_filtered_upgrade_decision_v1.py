...
ROOT = _PROJECT_ROOT
OUT_DIR = _report_path() / "gen3_range_filtered_upgrade_decision_v1"

GUARDED_SUMMARY = _report_path() / "gen3_guarded_candidate_package_v1" / "g3_guarded_candidate_summary.csv"
GUARDED_STRESS = _report_path() / "gen3_guarded_candidate_package_v1" / "g3_guarded_execution_stress_summary.csv"
RANGE_SUMMARY = _report_path() / "gen3_combo_range_filter_v1" / "combo_range_filter_summary.csv"
RANGE_STRESS = _report_path() / "gen3_combo_range_filter_execution_stress_v1" / "execution_stress_summary.csv"
RANGE_ROUTES = _report_path() / "gen3_combo_range_filter_execution_stress_v1" / "execution_stress_route_attribution.csv"
RANGE_WINDOWS = _report_path() / "gen3_combo_range_filter_execution_stress_v1" / "execution_stress_windows.csv"
