...
SOURCE = _report_path() / "gen3_range_second_acceptance_v1" / "deep_and_reclaim_any_second_accept__cost30" / "closed_trades.csv"
OUT_DIR = _report_path() / "gen3_range_second_acceptance_failure_audit_v1"
