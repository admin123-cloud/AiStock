...
ROOT = _PROJECT_ROOT
OUT_DIR = _report_path() / "gen3_guarded_intraday_visibility_audit_v1"

SELECTED_PATH = _report_path() / "gen3_guarded_candidate_package_v1" / "g3_guarded_candidate_closed_trades.csv"
