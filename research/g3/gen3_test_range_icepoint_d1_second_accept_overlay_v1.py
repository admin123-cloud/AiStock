...
RANGE_SOURCE = _report_path() / "gen3_range_second_acceptance_v1" / "deep_and_reclaim_d1_second_accept_signals.csv"
COMBO_SOURCE = _report_path() / "gen3_struct_veto_combo_e_candidate_v1" / "close_30bps_stressed_candidates.csv"
OUT_DIR = _report_path() / "gen3_range_icepoint_d1_second_accept_overlay_v1"
