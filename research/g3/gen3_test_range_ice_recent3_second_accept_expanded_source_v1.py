...
SOURCE = _report_path() / "gen3_range_second_acceptance_v1" / "base_with_second_acceptance_flags.csv"
OUT_DIR = _report_path() / "gen3_range_ice_recent3_second_accept_expanded_source_v1"
