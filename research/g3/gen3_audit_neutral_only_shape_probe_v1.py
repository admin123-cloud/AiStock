...
ROOT = _PROJECT_ROOT
SOURCE = _report_path() / "gen3_range_floor10_reclaim60_emotion_split_v1" / "neutral_only__cost30" / "closed_trades.csv"
OUT_DIR = _report_path() / "gen3_range_neutral_only_shape_probe_v1"
