...
ROOT = _PROJECT_ROOT
PANIC_CURVE = _report_path() / "gen3_panic_v2_research" / "failure_exit_30m_slot_resim_v1" / "m30_close5_full_nextopen_slot5_20pct_equity_curve.csv"
PANIC_TRADES = _report_path() / "gen3_panic_v2_research" / "failure_exit_30m_slot_resim_v1" / "m30_close5_full_nextopen_slot5_20pct_closed_trades.csv"
STRONG_CURVE = _report_path() / "gen2_v2_complete_strategy_2020" / "runs" / "official" / "full" / "equity_curve.csv"
STRONG_TRADES = _report_path() / "gen2_v2_complete_strategy_2020" / "runs" / "official" / "full" / "trades.csv"
OUT_DIR = _report_path() / "gen3_panic_strong_reference_combo_v1"
