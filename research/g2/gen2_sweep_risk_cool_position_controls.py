...
DEFAULT_CANDIDATES = _report_path() / "gen2_candidate_outcome_supervision" / "labeled_candidates.parquet"
DEFAULT_BASE_TRADES = _report_path() / "gen2_candidate_outcome_supervision" / "backtests" / "risk_cool_v2" / "trades.csv"
DEFAULT_OUTPUT_DIR = _report_path() / "gen2_risk_cool_position_controls"
