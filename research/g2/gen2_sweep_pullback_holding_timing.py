...
DEFAULT_SIGNAL_SOURCE = _report_path() / "gen2_v4_factor_profile" / "pullback_signal_factor_labeled.parquet"
DEFAULT_STATE_DAILY = _report_path() / "gen2_open_state_research_full" / "g2_open_state_daily.csv"
DEFAULT_OUTPUT_DIR = _report_path() / "gen2_pullback_holding_timing_sweep"
